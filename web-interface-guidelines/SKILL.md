...
description: Use when designing, reviewing, or implementing web UIs and you need concrete MUST/SHOULD/NEVER rules for accessibility, interaction patterns, forms, layout, animation, performance, content, or visual design decisions.
---
...
- MUST: Virtualize large lists (e.g., [virtua](https://github.com/inokawa/virtua))
